...
<body>
	...
	<%
		...
		//게시글이 유효하다면 request로 넘어온 bbsID에 해당하는 게시글을 가져온다.
		...
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<tr>
						<td>내용</td>
						<!-- 글 내용에 특수문자를 쓸 경우 특수문자까지 html로 치환해서 저장하기 위해 replaceAll()사용 -->
			...
			%>
				...
				<!-- 글 삭제 버튼 -->
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제하기</a>
